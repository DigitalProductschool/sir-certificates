/* eslint-disable prefer-const, react-hooks/rules-of-hooks, @typescript-eslint/no-explicit-any, @typescript-eslint/no-loss-of-precision, @typescript-eslint/no-this-alias */
...
const ssgi_poisson_compose_functions =
...
class SSGIEffect extends Effect {
  ...
  setSize(width, height, force = false) {
    let _this$gBufferDebugPas, _this$cubeToEquirectE;
  ...
  update(renderer, inputBuffer) {
    let _this$gBufferDebugPas2, _this$outputTexture$;
...
class Denoiser {
  constructor(scene, camera, texture, options = defaultDenosierOptions) {
    let _options$velocityDept, _this$denoisePass$tex, _this$denoisePass;
  ...
  setSize(width, height) {
    let _this$denoisePass2, _this$denoiserCompose;
  ...
  dispose() {
    let _this$denoisePass3, _this$denoiserCompose2;
  ...
  render(renderer, inputBuffer = null) {
    let _this$denoisePass4, _this$denoiserCompose4;
...
export { SSGIEffect, VelocityDepthNormalPass };
